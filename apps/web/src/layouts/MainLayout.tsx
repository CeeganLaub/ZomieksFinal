          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-10">
            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-9 h-9 rounded-lg bg-gray-800/80 hover:bg-primary hover:text-white text-gray-400 flex items-center justify-center transition-all duration-200 hover:scale-110">
                ...
                <a href="#" className="w-9 h-9 rounded-lg bg-gray-800/80 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 hover:text-white text-gray-400 flex items-center justify-center transition-all duration-200 hover:scale-110">
                ...
                <a href="#" className="w-9 h-9 rounded-lg bg-gray-800/80 hover:bg-blue-600 hover:text-white text-gray-400 flex items-center justify-center transition-all duration-200 hover:scale-110">
